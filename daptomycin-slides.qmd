...
![Daptomycin Structure](images/fig30-1-daptomycin-structure.png){width="80%"}
...
:::{.incremental}
1. **Calcium-dependent** binding to bacterial membrane
2. Preferential binding at **division septum**
3. Requires **phosphatidylglycerol** in membrane
4. **Oligomerization** in membrane
5. Membrane distortion → protein displacement
6. Ion leakage (K⁺) → cell death
:::
...
:::{.notes}
This is a significant clinical advantage compared to β-lactams and vancomycin, which cause cell lysis and release of inflammatory mediators. This may translate to less inflammatory injury in infections like endocarditis.
:::
...
:::{.notes}
CRITICAL teaching point: Daptomycin is inactivated by pulmonary surfactant and should NEVER be used for pneumonia! This is a common board question and clinical error.
:::
...
:::{.callout-warning}
**Calcium-supplemented Mueller-Hinton broth is REQUIRED**
(50 μg/mL calcium concentration)
:::
...
:::{.notes}
Again emphasize - DO NOT use for pneumonia! The good penetration into vegetations supports its use in endocarditis. Despite poor bone penetration, it has been used successfully in osteomyelitis, possibly due to concentration-dependent killing.
:::
...
3. Ensure source control
4. Monitor CPK closely
...
:::{.notes}
Use these questions for audience engagement or as study/review questions. Answers covered throughout lecture.
:::
...
See accompanying bibliography file for complete citations

Key sources:

- Mandell, Douglas & Bennett's *Principles and Practice of Infectious Diseases*
- IDSA Guidelines
- CLSI/EUCAST Breakpoint Documents
...
:::{.notes}
Open for questions. Remind students about common exam topics: mechanism, spectrum, contraindications (pneumonia!), adverse effects (CPK monitoring), and dosing strategies.
:::
