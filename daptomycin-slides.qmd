...
::: aside
This may be a clinical advantage compared to β-lactams and vancomycin, which cause cell lysis and release of inflammatory mediators. It has been hypothesized that this may translate to less inflammatory injury in infections like endocarditis [@Silverman2003].
:::
...
::: aside
Susceptibility testing for daptomycin is notoriously challenging. Labs should be aware that results can vary significantly. When possible, broth microdilution should be used, especially for serious infections [@Campeau2018; @Humphries2011].
:::
...
::: aside
Note the important 2019 CLSI change for E. faecium - the susceptible category was eliminated! The SDD (susceptible dose-dependent) category requires high-dose daptomycin (8-12 mg/kg/day). EUCAST has not established breakpoints for daptomycin [@CLSI2019].
:::
...
- However "clinical resistance" emerges during therapy
...
::: aside
While spontaneous resistance is rare, on-treatment emergence is a real concern, especially with undrained foci. This is why source control is essential and why combination therapy may be considered for complicated infections [@Silverman2001; @Fowler2006; @Sakoulas2006].
:::
...
::: aside
These changes all converge on reducing daptomycin's ability to bind and insert into the membrane. The reduction in phosphatidylglycerol is particularly important as this is the primary membrane target [@Mishra2012; @Sakoulas2006].
:::
...
::: aside
Understanding these mechanisms helps explain the seesaw effect. Mutations that increase positive charge or decrease phosphatidylglycerol to resist daptomycin often make the organism more susceptible to β-lactams. This is the basis for combination therapy [@Yang2009; @Howden2011; @Yang2010; @Peleg2012; @Arias2011].
:::
...
::: aside
This is one of the most important practical concepts. When you see a patient failing daptomycin or with an isolate showing elevated MICs, consider adding a β-lactam. Even against MRSA, adding oxacillin or ceftaroline can be beneficial - not because of intrinsic activity, but because of the seesaw effect [@Mehta2012; @Dhand2011].
:::
...
::: aside
Enterococcal resistance appears to be evolving somewhat independently of staphylococcal resistance. The LiaFSR system acts as a "sentinel" detecting antimicrobial peptides and orchestrating the stress response [@Arias2011b; @Tran2013; @Khan2019].
:::
...
::: aside
The long half-life supports once-daily dosing. High protein binding means the drug distributes mainly to plasma and interstitial fluid. Primarily renal elimination necessitates dose adjustment in renal impairment [@Dvorchik2003; @Benvenuto2006].
:::
...
::: aside
Note the linear pharmacokinetics up to 12 mg/kg. This supports the use of high-dose daptomycin in serious infections. PK/PD parameters correlating with efficacy are peak/MIC and AUC/MIC ratios [@Dvorchik2003; @Benvenuto2006; @Louie2001].
:::
...
::: aside
DO NOT use for pneumonia! The good penetration into vegetations supports its use in endocarditis. Despite poor bone penetration, it has been used successfully in osteomyelitis, possibly due to concentration-dependent killing [@Wise2002; @Cottagnoud2004; @Lee2008; @Traunmuller2010].
:::
...
::: aside
This is a critical point - FDA-approved doses are considered by many experts to be inadequate for serious infections. Data shows better outcomes with higher doses, especially for bacteremia with high mortality risk [@Arbeit2004; @Fowler2006; @Falcone2013; @Kullar2013].
:::
...
::: aside
For patients on CRRT, there's no uniform recommendation. Drug monitoring may be helpful. Some suggest 8 mg/kg q48h for CVVHDF. Monitor CPK more frequently in renal impairment [@FDA2020; @Khadzhynov2011; @Kielstein2014].
:::
...
::: aside
Muscle toxicity was the reason daptomycin was initially shelved. Once-daily dosing dramatically reduced this (lower trough concentrations), but it remains the primary monitoring concern. The microscopic findings show degeneration-regeneration without lysis or fibrosis [@Bhavnani2010; @Dare2018; @McConnell2017].
:::
...
::: aside
Symptoms typically appear after 7+ days of therapy and resolve within 3 days of stopping. Consider holding statins during daptomycin therapy if possible [@Fowler2006; @Arbeit2004; @Bhavnani2010].
:::
...
::: aside
Eosinophilic pneumonia is rare but potentially serious. Classic presentation: fever, dyspnea, pulmonary infiltrates, eosinophilia (peripheral or in BAL). High clinical suspicion needed - resolves with discontinuation, corticosteroids may help [@Fowler2006; @Silverman2007].
:::
...
<br> Monitor closely with:

- **Statins** - increased CPK risk
- PT/INR assays - may cause false elevation

::: aside
The lack of CYP450 metabolism is advantageous as it reduces drug-drug interactions. However, the combination with statins is particularly important given the shared muscle toxicity concern [@Dare2018; @McConnell2017].
:::
...
::: aside
These are the official indications, but daptomycin is widely used off-label for other gram-positive infections, particularly VRE infections and left-sided endocarditis when other options fail [@Arbeit2004; @Fowler2006].
:::
...
::: aside
The threshold for switching from vancomycin based on MIC is debated, but many clinicians become concerned with MICs approaching or at 2 μg/mL (the current breakpoint). Retrospective data suggest better outcomes with daptomycin in these scenarios [@Murray2013; @Kullar2011b; @Moore2012].
:::
...
::: aside
Combination therapy is increasingly used, especially for endocarditis and persistent bacteremia. The evidence base is largely from in vitro, animal, and retrospective human studies [@Mehta2012; @Dhand2011; @Sakoulas2014].
:::
...
::: aside
Ceftaroline is particularly interesting because it has intrinsic anti-MRSA activity AND provides the seesaw synergy. Multiple case reports show success with daptomycin + ceftaroline for otherwise refractory MRSA infections [@Dhand2011; @Barber2015; @Sakoulas2014b; @Mehta2012].
:::
...
::: aside
Be cautious with rifampin - some studies show antagonism. Gentamicin adds synergy but nephrotoxicity risk. The β-lactam combination is generally preferred based on current evidence [@Credito2007; @Rose2012].
:::
...
1.  Switch to high-dose daptomycin (8-10 mg/kg)

2.  Add β-lactam (ceftaroline or oxacillin)

3.  Ensure source control 4. Monitor CPK closely

<br> <br>

::: aside
This is a common clinical scenario. Key points: ensure adequate daptomycin dosing, add β-lactam for synergy and to prevent resistance, and don't forget about source control - undrained foci are the #1 reason for persistence [@Dhand2011; @Fowler2006; @Kullar2013].
:::

# Part 9: Quinupristin-Dalfopristin <br> (Brief overview) {background-color="#b20e10"}
...
- Limited availability -Italian marketing authorization revoked
