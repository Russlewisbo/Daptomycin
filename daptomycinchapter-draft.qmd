...
![Chemical structure of daptomycin](streptogramins-images/fig30-1-daptomycin-structure.png){#fig-daptomycin-structure}

## Mechanism of Action

![Mechanism of action of daptomycin. Calcium-dependent insertion into the bacterial membrane preferentially at the division septum leads to disruption of membrane architecture, loss of ions, and cell death without significant lysis.](streptogramins-images/damptomycin_MOA.png){#fig-daptomycin-moa fig-align="center"}
...
:::{.callout-note title="Key Feature: Bactericidal Without Cell Lysis"}
...
:::{.callout-warning title="Susceptibility Testing Requirements"}
...
The pharmacokinetics of once-daily intravenous daptomycin are linear up to doses of 12 mg/kg with minor accumulation [@Dvorchik2003]. Daptomycin exhibits a long terminal half-life (7.3–9.6 hours) and small volume of distribution (92–117 mL/kg), suggesting distribution mainly into plasma and interstitial fluid [@Dvorchik2003; @Benvenuto2006].
...
: Key pharmacokinetic parameters of daptomycin {#tbl-pk-params}

The mean daptomycin peak serum concentrations in healthy volunteers are approximately 55, 86, 116, 130, and 165 μg/mL after a single intravenous dose (infused over 30 minutes) of 4, 6, 8, 10, and 12 mg/kg, respectively [@Dvorchik2003; @Benvenuto2006]. The daptomycin area under the concentration-time curve (AUC~0–24 hr~) at steady state is in the range of 500 and 750 μg•hr/mL for once-daily doses of 4 and 6 mg/kg, respectively, and 850 μg•hr/mL for a dose of 8 mg/kg/day. The PK/PD parameters that best correlate with efficacy are peak/MIC and AUC/MIC ratios, supporting the concentration-dependent killing profile of daptomycin.

| Dose (mg/kg) | Peak C~max~ (μg/mL) | AUC~0–24h~ (μg·hr/mL) |
|---|---|---|
| 4 | ~55 | ~500 |
| 6 | ~86 | ~750 |
| 8 | ~116 | ~850 |
...
: Daptomycin peak serum concentrations and AUC by dose in healthy volunteers [@Dvorchik2003; @Benvenuto2006] {#tbl-pk-conc}
...
:::{.callout-note title="Tissue Penetration Summary"}
**Good penetration:**
...
- Bone (variable; C~max~ of 4.7 μg/mL reported in diabetic foot infection)
...
: Renal dose adjustment for daptomycin {#tbl-renal-dosing}
...
: Summary of daptomycin adverse effects {#tbl-adverse-effects}
...
: Potential combination partners for daptomycin with summary of evidence {#tbl-combinations}
...
:::{.callout-tip title="Clinical Scenario"}
**Presentation:** A patient has been on vancomycin for 7 days, but blood cultures remain positive for MRSA.

**Recommended approach:**

1. Switch to **high-dose daptomycin** (8–10 mg/kg/day)
2. Add a **β-lactam** (ceftaroline or oxacillin) to exploit the seesaw effect and prevent resistance emergence
3. Ensure **adequate source control** — undrained foci are the most common reason for persistent bacteremia
4. Monitor **CPK closely**, especially with high-dose therapy

This scenario illustrates several key principles: the importance of adequate daptomycin dosing for serious infections, the rationale for β-lactam combination therapy, and the critical role of source control in achieving microbiologic clearance.
:::
...
Quinupristin-dalfopristin (trade name: Synercid) is a combination of a streptogramin B (quinupristin, 30%) and a streptogramin A (dalfopristin, 70%). The two components act synergistically on the 50S ribosomal subunit of the 70S ribosome during the elongation stage of protein synthesis.

## Spectrum of Activity

Quinupristin-dalfopristin is active against most gram-positive organisms, with the notable exception of *Enterococcus faecalis*, which exhibits intrinsic resistance. The combination also has activity against select gram-negative organisms, including *Haemophilus influenzae* and *Moraxella catarrhalis*.

Variable rates of resistance among *Enterococcus faecium* isolates have been reported, while *Staphylococcus* spp. strains with elevated MICs to quinupristin-dalfopristin have been rare.

## Dosing and Administration

The intravenous dose is 7.5 mg/kg every 12 hours, administered as a 1-hour infusion. It is indicated for ABSSSI caused by *S. aureus* and *Streptococcus pyogenes*. Dosage adjustment is not required in renal failure, though a lower dose may be considered in the setting of hepatic disease.

:::{.callout-warning title="CYP3A4 Interactions"}
Quinupristin-dalfopristin is an inhibitor of the cytochrome P-450 3A4 isoenzyme system and may increase the levels of drugs metabolized through this pathway. This is an important distinction from daptomycin, which has minimal CYP450 interactions.
:::

## Limitations and Current Clinical Role

Despite its initial approval for VRE infections, quinupristin-dalfopristin is rarely used in contemporary clinical practice for several reasons:

- **Arthralgias and myalgias** — reported in up to 50% of patients, frequently leading to drug discontinuation
- **Severe infusion site reactions** — peripheral intravenous administration is poorly tolerated, typically necessitating central venous access
- **Limited availability** — the Italian marketing authorization has been revoked, and supply is limited in many other regions
- **CYP3A4 drug interactions** — complicating use in patients receiving multiple medications
- **Availability of better alternatives** — daptomycin and linezolid have largely supplanted quinupristin-dalfopristin for most gram-positive infections

The FDA approval of quinupristin-dalfopristin for VRE was withdrawn after initial trials failed to prove clinical benefit; however, anecdotal cases of success, usually in combination with other agents, for serious VRE infections suggest it may still have a role in selected patients. It may also retain utility in combination with daptomycin for refractory VRE infections when other options have been exhausted.

# Summary and Key Clinical Pearls

## Daptomycin Key Points

1. **Calcium-dependent** cyclic lipopeptide — susceptibility testing requires calcium-supplemented broth
2. Bactericidal without cell lysis; may reduce inflammatory mediator release
3. Spectrum overlaps glycopeptides; active against VISA, VRSA, and VRE
4. **Never use for pneumonia** — inactivated by pulmonary surfactant
5. FDA-approved doses (4–6 mg/kg/day) are often considered subtherapeutic for serious infections; experts recommend **8–12 mg/kg/day**
6. Monitor **CPK** at baseline and weekly; discontinue if CPK >1000 units/L with symptoms or >2000 units/L without
7. Renal dosing: **extend the interval** (every 48 hours) rather than reducing the dose

:::{.callout-tip title="Clinical Pearls"}
...
1. Why can't daptomycin be used for the treatment of pneumonia?
2. What is the seesaw effect and how is it clinically useful?
3. When should you suspect the emergence of daptomycin resistance during therapy?
4. At what CPK level should daptomycin be discontinued?
5. Why is high-dose daptomycin (8–12 mg/kg/day) preferred over FDA-approved doses for serious infections?
